...
*
* Copyright (c) 2017-2020, Futomi Hatano, All rights reserved.
...
// Discover the BLE Services
LinkingDevice.prototype._getServices = function () {
	return new Promise((resolve, reject) => {
...
LinkingDevice.prototype._getChars = function () {
	return new Promise((resolve, reject) => {
		let timer = setTimeout(() => {
			timer = null;
...
LinkingDevice.prototype._getCharsGattGenericAccess = function () {
	return new Promise((resolve, reject) => {
