...
LinkingDevice.prototype._initServices = function() {
	...
	if('Opening and closing' in this.info.exsensors) {
		this.services['openclose'] = {
			onnotify: null,
			start: this._opencloseStart.bind(this),
			stop: this._opencloseStop.bind(this),
		};
	}
	// Human detection
	if('Human detection' in this.info.exsensors) {
		this.services['human'] = {
			onnotify: null,
			start: this._humanStart.bind(this),
			stop: this._humanStop.bind(this),
		};
	}
	// Move
	if('Move' in this.info.exsensors) {
		this.services['move'] = {
			...
			stop: this._moveStop.bind(this),
		};
	}
	// Illuminance
	if('Illuminance' in this.info.exsensors) {
		this.services['illuminance'] = {
			onnotify: null,
			start: this._illuminanceStart.bind(this),
			stop: this._illuminanceStop.bind(this),
		};
	}
};
...
LinkingDevice.prototype._opencloseStart = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
...
LinkingDevice.prototype._opencloseStop = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
...
LinkingDevice.prototype._humanStart = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
...
LinkingDevice.prototype._humanStop = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
...
LinkingDevice.prototype._moveStart = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
...
LinkingDevice.prototype._moveStop = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
...
LinkingDevice.prototype._illuminanceStart = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
...
LinkingDevice.prototype._illuminanceStop = function() {
	let promise = new Promise((resolve, reject) => {
		this.write('SET_NOTIFY_SENSOR_INFO', {
			//SensorType: 0x00, // Gyroscope
			//SensorType: 0x01, // Accelerometer
